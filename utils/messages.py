...
def help_text() -> str:
    return (
        ...
        f"<code>/aviator amount</code> — cash out before the plane crashes\n"
...
def admin_help() -> str:
    return (
        ...
        f"<code>/admincmds</code> — OWNER-only control panel showing all registered admin commands. "
        f"Select a command to switch its permission between OWNER ONLY and OWNER + SUDO.\n\n"
